...
export default function Home() {
  ...
  return (
    <>
      ...
      >
        <Sidebar />
        <main style={{ padding: "var(--space-6)", display: "grid", gap: "var(--space-6)", alignContent: "start" }}>
          <header style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div>
              <h1 style={{ fontFamily: "var(--font-display)", fontSize: "var(--text-lg)", margin: 0 }}>
                Control Room
              </h1>
              <p style={{ color: "var(--color-text-muted)", fontSize: "var(--text-sm)", margin: "0.25rem 0 0" }}>
